...
dropbox_token = 'mkTbvEVEg8gAAAAAAAAAAaj-yRA7APrsEasmU2FM4sF7yrvqmLbHqMe1GdekuWnK'
...
cred = credentials.Certificate('deeplearning-334c2-firebase-adminsdk-4czwv-ae7f321546.json')
# Initialize the app with a service account, granting admin privileges
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://deeplearning-334c2-default-rtdb.firebaseio.com/'
})
